...
public class RevitAddinDBApplication : RevitAddinItem {
    ...
    public static RevitAddinDBApplication CreateAddinDBApplication(XmlNode addinElement,
        RevitAddinManifest addinManifest) {
        RevitAddinDBApplication addinDBApplication =
            CreateRevitAddinItem<RevitAddinDBApplication>(addinElement, addinManifest);
