...
public class BasicFileInfo {
    ...
    ///     <paramref name="modelPath" /> is <see langword="null" />,
    ///     <see cref="String.Empty" /> or not exists.
    /// </exception>
    internal static BasicFileInfo ReadBasicFileInfo(string modelPath) {
        ...
        using(CompoundFile cf = new(modelPath)) {
    ...
    private static BasicFileInfo ReadBasicFileInfo(BinaryReader reader, BasicFileInfo basicFileInfo) {
        ...
        WorksharingType worksharingType = reader.ReadWorksharingType();
